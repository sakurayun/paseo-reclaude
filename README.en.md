<table>
  <tr>
    ...
    <td>
      This project is a derivative work built on top of Claude Code, sponsored by <a href="https://www.reclaude.ai/"><b>Reclaude</b></a>. It is intended for learning and research purposes only, and not for any commercial use.
    </td>
  </tr>
</table>
...
A self-hosted relay uses `ws://` by default unless TLS is explicitly enabled. For a relay behind nginx listening on 443, start the daemon like this:
...
Minimal nginx WebSocket proxy config:
