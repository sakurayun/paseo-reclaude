...
interface SocketSessionOptions {
  ...
  // Fork cross-device sync pushes: fan an accepted push out to the other
  // connected clients, excluding the source connection. Only trusted client
  // connections provide these; hub sessions have no client fan-out.
...
export class VoiceAssistantWebSocketServer {
  ...
  private createSocketSession(options: SocketSessionOptions): Session {
    return new Session({
      ...
      onWorkspaceLayoutPushed: options.onWorkspaceLayoutPushed,
      onPromptPresetsPushed: options.onPromptPresetsPushed,
      onAppearanceSettingsPushed: options.onAppearanceSettingsPushed,
      modelPreferencesStore: this.modelPreferencesStore,
      onModelPreferencesPushed: options.onModelPreferencesPushed,
      composerDraftsStore: this.composerDraftsStore,
      onComposerDraftsPushed: options.onComposerDraftsPushed,
