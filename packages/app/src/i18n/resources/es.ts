...
export const es: TranslationResources = {
  ...
  sessions: {
    workspacePanel: {
      ...
      closedTerminals: "Terminales cerradas",
      restoreTerminal: "Reabrir",
  ...
  message: {
    actions: {
      ...
      showFullResponse: "Mostrar {{count}} secciones ocultas",
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      context: {
        ...
        revealInExplorer: "Mostrar en Explorer",
      ...
      toasts: {
        ...
        deleted: "Eliminado",
        localOnly: "Disponible solo con un host local en escritorio",
        updateHostToMutate: "Actualiza el host para gestionar archivos.",
        copyContentsBinary: "No se puede copiar el contenido de un archivo binario",
      },
      actions: {
        back: "Atrás",
        retry: "Rever",
    ...
    tabs: {
      ...
      closePrompt: {
        agentTitle: "Cerrar pestaña",
        terminalTitle: "Cerrar pestaña",
        closeTabLabel: "Cerrar pestaña",
        closeTabAgentDescription: "Solo quita la pestaña: la sesión sigue en la barra lateral.",
        closeTabTerminalDescription: "Solo quita la pestaña: la terminal sigue ejecutándose.",
        archiveAgentLabel: "Archivar sesión",
        archiveAgentDescription: "Cierra la pestaña y archiva la sesión.",
        killTerminalLabel: "Cerrar la terminal definitivamente",
        killTerminalDescription:
          "Detiene la terminal y la quita de la lista del espacio de trabajo. Podrás encontrarla en el historial de sesiones.",
      },
      confirmations: {
  ...
  sidebar: {
    ...
    sessionsList: {
      ...
      newAgentInWorkspace: "Nuevo agente en este espacio de trabajo",
      history: "Historial",
      empty: "Aún no hay sesiones",
    ...
    workspace: {
      sessions: {
        ...
        archive: "Archivar",
        archiveSelected: "Archivar ({{count}})",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        registrationFailed:
          "El demonio integrado se inició, pero Paseo no pudo guardar la conexión localhost. Desactive y vuelva a activar la gestión del demonio, o agregue localhost manualmente.",
        pausedStopFailed:
  ...
  providerUsage: {
    ...
    reclaude: {
      ...
      loggedIn: "Sesión iniciada en ReClaude",
      loggedInAs: "Sesión iniciada como {{email}}",
      logout: "Cerrar sesión",
      loginTitle: "Iniciar sesión en ReClaude",
      ...
      mfaHint: "Introduce el código de verificación de tu cuenta de ReClaude",
    ...
    reset: {
      ...
      unitSeconds: "{{value}} s",
      resetsIn: "se restablece en {{countdown}}",
    },
    risk: {
    ...
    windows: {
      ...
      weekly: "Semanal",
      weeklyOpus: "Semanal · Opus",
      weeklyOmelette: "Semanal · Omelette",
      weeklySonnet: "Semanal · Sonnet",
      weeklyDesign: "Semanal · Design",
      weeklyModel: "Semanal · {{model}}",
      codeReview: "Revisión de código",
      monthly: "Mensual",
      codingUsage: "Uso de codificación",
      planUsage: "Uso del plan",
      modelInterval: "{{model}} · Intervalo",
      modelWeekly: "{{model}} · Semanal",
    },
    balances: {
      monthlyCredits: "Créditos mensuales",
      onDemandCap: "Límite bajo demanda",
      prepaidCredits: "Créditos prepago",
      planUsage: "Uso del plan",
      credits: "Créditos",
    },
    plans: {
    ...
    details: {
      periodStart: "Inicio del período de facturación",
      periodEnd: "Fin del período de facturación",
      weekStarts: "Inicio de la semana",
      weekResets: "Reinicio semanal",
    ...
    detailValues: {
      ...
      monthly: "Mensual",
      unified: "Unificado",
      previousCycleCredits: "{{period}} · {{credits}} créditos",
    },
    errors: {
      grokSignIn:
        "Inicia sesión con `grok login` o configura XAI_API_KEY para ver el uso de Grok Build.",
      grokSessionExpired: "La sesión de Grok caducó. Ejecuta `grok login` y actualiza el uso.",
      billingHttp: "Falló la solicitud a la API de facturación.",
      parseFailed: "No se pudo analizar la respuesta de uso.",
  ...
  settings: {
    ...
    appearance: {
      ...
      terminal: {
        ...
        colorScheme: {
          ...
          hint: "Anula los colores del terminal independientemente del tema de la aplicación para mantener legibles los prompts del shell",
          accessibilityLabel: "Esquema de color del terminal: {{value}}",
          options: {
            auto: "Seguir el tema",
    ...
    shortcuts: {
      ...
      help: {
        ...
        copyFilePath: "Copiar ruta",
        copyRelativeFilePath: "Copiar ruta relativa",
    ...
    host: {
      ...
      agents: {
        unavailable: "Conéctese a este host para administrar agentes",
      },
      browserTools: {
        title: "Herramientas del navegador",
        hint: "Permitir que los agentes accedan y controlen las pestañas del navegador de Paseo, incluido el estado de inicio de sesión. Actívalo solo para agentes de confianza.",
        updating: "Actualizando herramientas del navegateur…",
      },
      terminalAgents: {
        sectionTitle: "Agentes de terminal",
        enableTitle: "Activar hooks de agentes de terminal",
        enableHint:
          "Recibe notificaciones y estado de agentes de terminal. Instala hooks en los archivos de configuración del agente.",
        updateFailedTitle: "No se pudieron actualizar los hooks de agentes de terminal",
      },
      workspaces: {
        unavailable: "Conéctese a este host para administrar espacios de trabajo",
        autoArchive: {
      ...
      daemon: {
        ...
        remove: {
          title: "Eliminar host",
          localTitle: "Quitar conexión localhost",
          hint: "Elimina este host y sus conexiones guardadas de este dispositivo",
          localHint: "Quita localhost de este dispositivo y detiene el demonio integrado",
          localConfirmTitle: "¿Quitar la conexión localhost y detener el demonio?",
          confirmMessage: "¿Quitar{{name}}? Esto eliminará sus conexiones guardadas.",
          localConfirmMessage:
            "Esto quitará la conexión localhost, desactivará la gestión del demonio integrado y detendrá el demonio gestionado. Los hosts remotos permanecen conectados.",
          errorTitle: "Error",
          errorMessage: "No se puede eliminar el host",
          localErrorMessage: "No se puede quitar la conexión localhost",
        },
      },
      dictation: {
    ...
    providers: {
      ...
      loading: "Cargando...",
      addErrorTitle: "No se puede agregar el proveedor",
    ...
    project: {
      ...
      appearance: {
        ...
        saveFailed: "No se pudo guardar la apariencia del proyecto",
  ...
  ssh: {
    ...
    hosts: {
      title: "Hosts",
      empty: "Aún no hay hosts",
      emptyDescription: "Añade un host para conectarte por SSH.",
      newHost: "Nuevo host",
      connect: "Conectar",
      edit: "Editar",
      connecting: "Conectando…",
      connectFailed: "Error de conexión",
      hostKeyMismatchTitle: "La clave del host cambió",
      hostKeyMismatchBody:
        "La clave del host de {{host}} no coincide con la registrada. Esto podría indicar un ataque de intermediario. Actualízala solo si confías en este cambio.",
      hostKeyMismatchConfirm: "Confiar en la nueva clave",
      unavailable: "Actualiza el host para usar el gestor de SSH.",
      menu: {
        newTabConnect: "Conectar en una pestaña nueva",
        closeAllShells: "Cerrar todas las shells SSH",
        closeAllShellsTitle: "¿Cerrar todas las shells SSH?",
        closeAllShellsMessage: "Esto cerrará {{count}} terminal(es) SSH en todos los hosts.",
      },
    },
    connect: {
      tabLabel: "Conectando",
      ...
      confirm: "Conectar",
      retry: "Reintentar",
      trust: "Confiar y reconectar",
      close: "Cerrar",
      ended: "Esta conexión ha finalizado.",
      mismatchTitle: "La clave del host cambió",
      mismatchMessage:
        "La clave del host no coincide con la registrada. Confía en ella solo si esperabas este cambio.",
      errorTitle: "Error de conexión",
      genericError: "Error de conexión",
      retryingLog: "Reintentando…",
      trustingLog: "Confiando en la clave del host y reconectando…",
      savePasswordTitle: "¿Guardar la contraseña?",
      savePasswordMessage: "¿Guardar esta contraseña para {{host}} para futuras conexiones?",
      savePasswordConfirm: "Guardar",
    ...
    form: {
      ...
      credentialsSection: "Credenciales",
      ...
      useFido2: "Llave de seguridad FIDO2",
      agentForwarding: "Reenvío del agente",
      useAgentHint:
      ...
      startupSnippet: "Script de inicio",
      hostChaining: "Encadenamiento de hosts",
      proxy: "Proxy",
      environment: "Variables de entorno",
      charset: "Juego de caracteres",
      backspace: "Tecla de retroceso",
      backspaceDel: "Suprimir (DEL)",
      ...
      cancel: "Cancelar",
      delete: "Eliminar",
      fido2Notice: "Las llaves FIDO2 se conectan a través del binario ssh del sistema.",
      moshNotice: "Mosh se conecta a través del binario mosh del sistema.",
    },
    keychain: {
      title: "Llavero",
      ...
      importFromFile: "Importar desde archivo de clave",
    ...
    knownHosts: {
      ...
      empty: "Aún no hay hosts conocidos",
      import: "Importar",
      imported: "Se importaron {{count}} claves de host",
      delete: "Eliminar",
    },
    logs: {
      title: "Registros",
      empty: "Aún no hay historial de conexiones",
      date: "Fecha",
      user: "Usuario",
      host: "Host",
      duration: "Duración",
    ...
    uploads: {
      dropSheet: {
        title: "Soltar en {{host}}",
        pastePaths: "Pegar rutas",
        pastePathsDescription: "Inserta las rutas locales de los archivos en la terminal",
        scanning: "Analizando los elementos soltados…",
        scanningDescription: "Contando los archivos de las carpetas soltadas",
        uploadAll: "Subir todos ({{count}}) los archivos",
        nothingToUpload: "No se encontraron archivos en los elementos soltados",
        uploadDescription: "Enviar {{size}} al host remoto por SFTP",
        uploadDescriptionTruncated: "Enviar {{size}} por SFTP (lista de archivos truncada)",
        destDirLabel: "Directorio de destino remoto",
        sftpUnavailable:
          "Este host se conecta mediante Mosh/FIDO2 — la subida por SFTP no está disponible",
        uploadFailed: "Error al subir: {{error}}",
      },
      panel: {
        title: "Subidas SSH",
        empty: "Aún no hay subidas",
        stopAll: "Detener todas las subidas",
        clearFinished: "Limpiar subidas terminadas",
        close: "Cerrar panel",
        statusActive: "Subiendo {{percent}}%",
        status: {
          active: "Subiendo",
          done: "Completado",
          error: "Falló",
        ...
        pillActive: "{{count}} subiendo",
        pillIdle: "{{count}} subidas",
      },
      menu: {
        jumpDir: "Abrir esta carpeta en la terminal",
        jumpFile: "Abrir la carpeta del archivo en la terminal",
        copyRemotePath: "Copiar ruta remota",
        cancelFile: "Detener la subida de este archivo",
        cancelDir: "Detener las subidas de esta carpeta ({{count}})",
        cancelUpload: "Detener esta subida",
      },
      jump: {
        noTerminal: "No hay terminal conectada para este host",
        busyTitle: "Terminal ocupada",
        busyMessage:
          "La terminal parece estar ejecutando una tarea. ¿Enviar el comando cd de todos modos?",
        busyConfirm: "Ir de todos modos",
      },
    },
  },
};
