...
export const ptBR: TranslationResources = {
  ...
  sessions: {
    workspacePanel: {
      ...
      closedTerminals: "Terminais fechados",
  ...
  message: {
    actions: {
      ...
      showFullResponse: "Mostrar {{count}} seções ocultas",
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      context: {
        ...
        revealInExplorer: "Mostrar no Explorer",
      ...
      confirm: {
        deleteTitle: "Excluir?",
        deleteMessage: 'Excluir "{{name}}"? Esta ação não pode ser desfeita.',
      },
      toasts: {
        created: "Criado",
        renamed: "Renomeado",
        ...
        deleted: "Excluído",
        localOnly: "Disponível apenas com um host local no desktop",
        updateHostToMutate: "Atualize o host para gerenciar arquivos.",
        copyContentsBinary: "Não é possível copiar o conteúdo de um arquivo binário",
      },
      actions: {
        back: "Voltar",
        retry: "Tentar novamente",
    ...
    tabs: {
      ...
      closePrompt: {
        agentTitle: "Fechar aba",
        terminalTitle: "Fechar aba",
        closeTabLabel: "Fechar aba",
        closeTabAgentDescription: "Remove apenas a aba — a sessão continua na barra lateral.",
        closeTabTerminalDescription: "Remove apenas a aba — o terminal continua em execução.",
        archiveAgentLabel: "Arquivar sessão",
        archiveAgentDescription: "Fecha a aba e arquiva a sessão.",
        killTerminalLabel: "Fechar o terminal de vez",
  ...
  providerUsage: {
    ...
    footer: {
      ...
      sourceUpdated: "{{source}} · Atualizado {{time}}",
    },
    providers: {
      claude: "Claude",
      codex: "Codex",
    ...
    balances: {
      ...
      onDemandCap: "Limite sob demanda",
      prepaidCredits: "Créditos pré-pagos",
      planUsage: "Uso do plano",
      credits: "Créditos",
    },
    plans: {
    ...
    details: {
      ...
      quotaReset: "Redefinição de cota",
      account: "Conta",
    },
    detailValues: {
      enabled: "Ativado",
    ...
    errors: {
      grokSignIn: "Entre com `grok login` ou defina XAI_API_KEY para ver o uso do Grok Build.",
      grokSessionExpired: "Sessão do Grok expirada. Execute `grok login` e atualize o uso.",
      billingHttp: "Falha na solicitação da API de cobrança.",
      parseFailed: "Não foi possível analisar a resposta de uso.",
      codexChatgptAuthRequired:
        "Os limites oficiais do Codex exigem login no ChatGPT. Com API key / Base URL personalizada (NewAPI / Sub2API / CPA), o uso é lido do gateway.",
    },
    meter: {
      accessibilityUsed: "Uso do plano {{percentage}}% usado",
      accessibilityRemaining: "Uso do plano {{percentage}}% restante",
      percentageMode: {
        label: "Porcentagem do anel de uso",
        description: "Mostrar porcentagem usada ou restante no anel de uso do compositor.",
        used: "Usado",
        remaining: "Restante",
      },
    },
    grok: {
      ...
      authenticated: "Credenciais do Grok Build encontradas",
      needAuth: "Entre com `grok login` ou defina XAI_API_KEY",
      refreshInterval: {
        label: "Atualização automática do Grok",
        description:
          "Com que frequência o anel de uso do Grok no compositor busca dados de faturamento.",
        off: "Desligado",
        minutes: "{{count}} min",
      },
    },
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        copyRelativeFilePath: "Copiar caminho relativo",
        renameFile: "Renomear",
        deleteFile: "Excluir",
    ...
    host: {
      ...
      browserTools: {
        ...
        hint: "Permitir que agentes acessem e controlem abas do navegador do Paseo, incluindo o estado de login. Ative apenas para agentes confiáveis.",
        updating: "Atualizando ferramentas do navegador…",
      },
      terminalAgents: {
        sectionTitle: "Agentes de terminal",
        enableTitle: "Ativar hooks de agentes de terminal",
        enableHint:
          "Receba notificações e status de agentes de terminal. Isso instala hooks nos arquivos de configuração do agente.",
        updateFailedTitle: "Não foi possível atualizar os hooks de agentes de terminal",
      },
      workspaces: {
    ...
    project: {
      ...
      appearance: {
        ...
        saveFailed: "Não foi possível salvar a aparência do projeto",
  ...
  ssh: {
    ...
    sections: {
      hosts: "Hosts",
      keychain: "Chaveiro",
      forwards: "Encaminhamento de portas",
      knownHosts: "Hosts conhecidos",
      logs: "Registros",
    },
    hosts: {
      title: "Hosts",
      empty: "Nenhum host ainda",
      emptyDescription: "Adicione um host para conectar via SSH.",
      newHost: "Novo host",
      connect: "Conectar",
      edit: "Editar",
      connecting: "Conectando…",
      connectFailed: "Falha na conexão",
      hostKeyMismatchTitle: "A chave do host mudou",
      hostKeyMismatchBody:
        "A chave do host de {{host}} não corresponde à registrada. Isso pode indicar um ataque de intermediário. Atualize somente se você confiar nesta mudança.",
      hostKeyMismatchConfirm: "Confiar na nova chave",
      unavailable: "Atualize o host para usar o gerenciador de SSH.",
      menu: {
        newTabConnect: "Conectar em uma nova aba",
        closeAllShells: "Fechar todas as shells SSH",
        closeAllShellsTitle: "Fechar todas as shells SSH?",
        closeAllShellsMessage: "Isso fechará {{count}} terminal(is) SSH em todos os hosts.",
      },
    },
    connect: {
      tabLabel: "Conectando",
      ...
      confirm: "Conectar",
      retry: "Tentar novamente",
      trust: "Confiar e reconectar",
      close: "Fechar",
      ended: "Esta conexão foi encerrada.",
      mismatchTitle: "A chave do host mudou",
      mismatchMessage:
        "A chave do host não corresponde à registrada. Confie nela apenas se você esperava essa mudança.",
      errorTitle: "Falha na conexão",
      genericError: "Falha na conexão",
      retryingLog: "Tentando novamente…",
      trustingLog: "Confiando na chave do host e reconectando…",
    ...
    form: {
      ...
      cancel: "Cancelar",
      delete: "Excluir",
      fido2Notice: "As chaves FIDO2 conectam através do binário ssh do sistema.",
      moshNotice: "O Mosh conecta através do binário mosh do sistema.",
    },
    keychain: {
      title: "Chaveiro",
      ...
      importFromFile: "Importar de arquivo de chave",
      typeUnknown: "Tipo desconhecido",
    },
    forwards: {
      title: "Encaminhamento de portas",
      empty: "Nenhum encaminhamento de porta ainda",
      ...
      targetHost: "Endereço de destino",
    ...
    knownHosts: {
      ...
      empty: "Nenhum host conhecido ainda",
      import: "Importar",
      imported: "{{count}} chaves de host importadas",
      delete: "Excluir",
    },
    logs: {
      title: "Registros",
      empty: "Nenhum histórico de conexão ainda",
      date: "Data",
      user: "Usuário",
      host: "Host",
      duration: "Duração",
    ...
    uploads: {
      dropSheet: {
        title: "Soltar em {{host}}",
        pastePaths: "Colar caminhos",
        pastePathsDescription: "Insere os caminhos locais dos arquivos no terminal",
        scanning: "Analisando os itens soltos…",
        scanningDescription: "Contando os arquivos das pastas soltas",
        uploadAll: "Enviar todos os ({{count}}) arquivos",
        nothingToUpload: "Nenhum arquivo encontrado nos itens soltos",
        uploadDescription: "Enviar {{size}} para o host remoto via SFTP",
        uploadDescriptionTruncated: "Enviar {{size}} via SFTP (lista de arquivos truncada)",
        destDirLabel: "Diretório de destino remoto",
        sftpUnavailable: "Este host conecta via Mosh/FIDO2 — o envio por SFTP não está disponível",
        uploadFailed: "Falha no envio: {{error}}",
      },
      panel: {
        title: "Envios SSH",
        empty: "Nenhum envio ainda",
        stopAll: "Parar todos os envios",
        clearFinished: "Limpar envios concluídos",
        close: "Fechar painel",
        statusActive: "Enviando {{percent}}%",
        status: {
          active: "Enviando",
          done: "Concluído",
          error: "Falhou",
        ...
        pillActive: "{{count}} enviando",
        pillIdle: "{{count}} envios",
      },
      menu: {
        jumpDir: "Abrir esta pasta no terminal",
        jumpFile: "Abrir a pasta do arquivo no terminal",
        copyRemotePath: "Copiar caminho remoto",
        cancelFile: "Parar o envio deste arquivo",
        cancelDir: "Parar os envios desta pasta ({{count}})",
        cancelUpload: "Parar este envio",
      },
      jump: {
        noTerminal: "Nenhum terminal conectado para este host",
        busyTitle: "Terminal ocupado",
        busyMessage:
          "O terminal parece estar executando uma tarefa. Enviar o comando cd mesmo assim?",
        busyConfirm: "Ir mesmo assim",
      },
    },
  },
};
