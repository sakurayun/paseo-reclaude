...
export const ja: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      messagesScopeNote: "読み込み済みのセッションのみ検索します",
    },
  },
  composer: {
    draftConflict: {
  ...
  agentControls: {
    ...
    features: {
      ...
      known: {
        fast_mode: {
          label: "高速",
          description: "トークンコストは高くなりますが、応答のレイテンシが低くなります",
          tooltip: "高速モードを切り替え",
        },
        ultracode: {
          label: "Ultracode",
    ...
    gateway: {
      nativeLabel: "ネイティブ",
      fallbackLabel: "モデルゲートウェイ",
      sheetTitle: "モデルゲートウェイ",
      selectAccessibilityLabel: "モデルゲートウェイを選択",
      selectAccessibilityLabelWithValue: "モデルゲートウェイを選択（{{value}}）",
    },
  },
  agentStream: {
  ...
  sessions: {
    workspacePanel: {
      tabSubtitle: "ワークスペースのセッション履歴",
      includeArchived: "アーカイブ済みを表示",
      closedTerminals: "閉じたターミナル",
      restoreTerminal: "再度開く",
      empty: "このワークスペースにはまだセッションがありません",
      otherSection: "その他の場所",
      currentBadge: "現在",
      untitled: "無題のセッション",
    },
  ...
  message: {
    actions: {
      ...
      showFullResponse: "非表示のセクション {{count}} 件を表示",
      forkMenu: "メッセージをフォーク",
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      context: {
        ...
        openWith: "{{editor}} で開く",
        openUnavailable: "IDE で開く機能はデスクトップアプリでのみ利用できます。",
        newFile: "新規ファイル",
        newFolder: "新規フォルダー",
        duplicate: "複製",
        viewFile: "ファイルを表示",
    ...
    tabs: {
      ...
      closePrompt: {
        agentTitle: "タブを閉じる",
        terminalTitle: "タブを閉じる",
        closeTabLabel: "タブを閉じる",
        closeTabAgentDescription: "タブのみを閉じます。セッションはサイドバーに残ります。",
        closeTabTerminalDescription: "タブのみを閉じます。ターミナルは実行を続けます。",
        archiveAgentLabel: "セッションをアーカイブ",
        archiveAgentDescription: "タブを閉じてセッションをアーカイブします。",
        killTerminalLabel: "ターミナルを完全に閉じる",
    ...
    portForwards: {
      title: "ポートフォワーディング",
      subtitle: "リモートポートをこのデバイスに転送",
      description:
        "リモートのデーモンホスト上のポートを、このマシンのローカルポートにマッピングします。このリストは接続中のすべてのデバイス間で共有されます。",
      desktopOnlyNotice:
        "フォワードはデスクトップでのみ有効になります。ここでリストを管理できますが、このデバイスはローカルポートをバインドしません。",
      needsUpdate: "ポートフォワーディングを使用するにはホストを更新してください。",
      localPortLabel: "ローカルポート",
      localPortPlaceholder: "例: 3000",
      remotePortLabel: "リモートポート",
      remotePortPlaceholder: "例: 3000",
      labelPlaceholder: "ラベル（任意）",
      addButton: "フォワードを追加",
      empty: "ポートフォワードはまだありません",
      statusActive: "有効",
      statusDesktopOnly: "デスクトップのみ",
      deleteLabel: "ポート転送を削除",
    },
    header: {
      actions: {
    ...
    sourceControl: {
      commit: {
        ...
        showMore: "もっと見る",
        showLess: "折りたたむ",
        filesError: "変更ファイルの読み込みに失敗しました",
        noFiles: "ファイルの変更はありません",
      },
      changes: {
        title: "変更",
        placeholder: "コミットメッセージ（任意）",
        clean: "未コミットの変更はありません",
        stagedTitle: "ステージ済みの変更",
        unstagedTitle: "変更",
        stage: "ステージ",
        unstage: "ステージ解除",
        discard: "変更を破棄",
        ignore: ".gitignore に追加",
        filesEmpty: "変更されたファイルはありません",
        filesError: "変更ファイルの読み込みに失敗しました",
        openChanges: "変更を開く",
        openFile: "ファイルを開く",
        stashSelected: "選択した変更をスタッシュ（{{count}}）",
        revealInFileManager: "ファイルマネージャーで表示",
        copyPatch: "変更をパッチとしてコピー（{{count}}）",
        copyRelativePath: "相対パスをコピー（{{count}}）",
        copiedPatch: "パッチをコピーしました",
        copiedPath: "パスをコピーしました",
        stageSelected: "選択した変更をステージ（{{count}}）",
        unstageSelected: "選択した変更をステージ解除（{{count}}）",
        ignoreSelected: "選択した変更を .gitignore に追加（{{count}}）",
        discardSelected: "選択した変更を破棄（{{count}}）",
        discardSelectedConfirmTitle: "{{count}} 件のファイルの変更を破棄しますか？",
        discardConfirmTitle: "{{path}} の変更を破棄しますか？",
        discardConfirmMessage:
          "追跡対象の変更は HEAD から復元され、追跡対象外のファイルは削除されます。この操作は取り消せません。",
      },
      branches: {
        title: "ブランチ",
        empty: "ブランチはありません",
        error: "ブランチの読み込みに失敗しました",
        current: "現在",
      ...
      stashes: {
        title: "スタッシュ",
        empty: "スタッシュはありません",
        error: "スタッシュの読み込みに失敗しました",
        save: "スタッシュ",
        saved: "変更をスタッシュしました",
        saveFailed: "スタッシュに失敗しました",
        pop: "ポップ",
        popped: "スタッシュを適用しました",
        popFailed: "スタッシュの適用に失敗しました",
      },
      updateHost: "ソース管理を使用するにはホストを更新してください",
      hostVersion: "接続中のホスト: {{host}}（デーモン {{version}}）",
      hostVersionUnknown: "不明",
      repo: {
        title: "リポジトリ",
        detached: "切り離された HEAD",
        noRemote: "リモートなし",
        dirty: "未コミットの変更",
        clean: "クリーン",
      },
      sync: {
        ...
        ahead: "{{value}} 件先行",
        behind: "{{value}} 件遅延",
        upToDate: "origin と同期済み",
      },
      menu: {
        trigger: "リポジトリ操作",
        opSuccess: "完了",
        opFailed: "Git 操作に失敗しました",
        confirm: "確認",
        pullRebase: "プル（リベース）",
        fetch: "フェッチ",
        fetchPrune: "フェッチ（プルーン）",
        fetchAll: "すべてのリモートからフェッチ",
        commit: "コミット",
        changes: "変更",
        pullPush: "プル、プッシュ",
        branch: "ブランチ",
        ...
        stash: "スタッシュ",
        tags: "タグ",
        undoLastCommit: "最後のコミットを取り消す",
        abortRebase: "リベースを中止",
        commitStagedAmend: "ステージ済みをコミット（修正）",
        commitAllAmend: "すべてコミット（修正）",
        stageAll: "すべての変更をステージ",
        unstageAll: "すべての変更をステージ解除",
        discardAll: "すべての変更を破棄",
        discardAllConfirmTitle: "すべての変更を破棄しますか？",
        discardAllConfirmMessage:
          "未コミットの変更はすべて破棄され、追跡対象外のファイルは削除されます。この操作は元に戻せません。",
        ...
        renameBranchTitle: "ブランチ名を変更",
        branchNamePlaceholder: "ブランチ名",
        deleteBranch: "ブランチを削除...",
        deleteBranchConfirmTitle: "ブランチ {{branch}} を削除しますか？",
        deleteBranchConfirmMessage: "ブランチはローカルで強制削除されます。",
        addRemote: "リモートを追加...",
        addRemoteNameTitle: "リモートを追加：名前",
        addRemoteUrlTitle: "リモートを追加：URL",
        remoteNamePlaceholder: "リモート名",
        remoteUrlPlaceholder: "リモート URL",
        removeRemote: "リモートを削除...",
        removeRemoteConfirmTitle: "リモート {{remote}} を削除しますか？",
        removeRemoteConfirmMessage: "リモートとその追跡ブランチがローカルから削除されます。",
        noRemotes: "リモートなし",
        stashPlain: "スタッシュ",
        stashUntracked: "スタッシュ（追跡対象外を含む）",
        stashStaged: "ステージ済みをスタッシュ",
        applyLatestStash: "最新のスタッシュを適用",
        applyStash: "スタッシュを適用...",
        popLatestStash: "最新のスタッシュをポップ",
        popStash: "スタッシュをポップ...",
        dropStash: "スタッシュを削除...",
        dropStashConfirmTitle: "スタッシュを削除しますか？",
        dropStashConfirmMessage: "このスタッシュエントリは完全に削除されます。",
        clearStashes: "すべてのスタッシュを削除...",
        clearStashesConfirmTitle: "すべてのスタッシュを削除しますか？",
        clearStashesConfirmMessage: "すべてのスタッシュエントリが完全に削除されます。",
        noStashes: "スタッシュなし",
        createTag: "タグを作成...",
        createTagTitle: "タグを作成",
  ...
  sidebar: {
    grouping: {
      accessibilityLabel: "サイドバーのグループ化",
      groupBy: "グループ化基準",
      project: "プロジェクト",
      workspace: "ワークスペース",
      status: "ステータス",
    ...
    workspace: {
      ...
      status: {
        ...
        checksFailed_one: "{{count}} 件失敗",
        checksFailed_other: "{{count}} 件失敗",
        creating: "作成中...",
      },
      actions: {
        menu: "ワークスペースアクション",
  ...
  todoTrack: {
    header: "Todo {{completed}}/{{total}}",
    allDone: "すべての Todo が完了しました",
  },
  sidechainTrack: {
    header: "サブエージェント {{completed}}/{{total}}",
    allDone: "すべてのサブエージェントが完了しました",
    closePanel: "サブエージェントの状態を非表示",
    removeEntry: "リストから削除",
  },
  desktop: {
    quitting: {
  ...
  subagents: {
    ...
    archiveDialog: {
      fallbackLabel: "このサブエージェント",
      runningTitle: "実行中のサブエージェントをアーカイブしますか？",
      title: "サブエージェントをアーカイブしますか？",
      runningMessage:
        "{{label}} はまだ実行中です。アーカイブするとサブエージェントが停止し、トラックから削除されます。",
      message: "{{label}} をトラックから削除します。サブエージェントはアーカイブされます。",
      confirmLabel: "アーカイブ",
      cancelLabel: "キャンセル",
    },
  ...
  panels: {
    ...
    file: {
      ...
      directoryOpenedInExplorer:
        "このパスはフォルダーです。ファイルエクスプローラーで表示しています。",
      openInExplorer: "ファイルエクスプローラーで開く",
  ...
  contextWindow: {
    ...
    quota: {
      loading: "プラン使用量を読み込み中…",
      planUsage: "プラン使用量",
      usage: "使用量",
      used: "使用量 {{used}} / {{limit}}",
      resettingNow: "まもなくリセット",
      resetsDays: "{{value}}日後にリセット",
      resetsHours: "{{value}}時間後にリセット",
      resetsMinutes: "{{value}}分後にリセット",
      claude: {
        fiveHour: "5時間の上限",
        weeklyAll: "週間 · 全モデル",
        weeklyOpus: "週間 · Opus",
        weeklyDesign: "週間 · Design",
        overageEnabled: "超過クレジット: 有効",
        reclaudeUnsupported: "reclaude 環境では使用量の照会はできません",
      },
      codex: {
        session: "セッション",
        weekly: "週間",
        codeReview: "コードレビュー",
        creditsRemaining: "残りクレジット: ${{amount}}",
      },
      copilot: {
      ...
      cursor: {
        title: "Cursor 使用量",
        spent: "使用 {{spent}} / {{limit}}",
        billingResets: "請求は {{date}} にリセット",
      },
      zai: {
        title: "Z.ai",
        status: "ステータス: {{status}}",
      ...
      grok: {
        title: "Grok Build クォータ",
      },
      kimi: {
        title: "Kimi Code クォータ",
        noData: "クォータデータがありません",
      },
    },
  },
  providerUsage: {
    ...
    reclaude: {
      ...
      loginButton: "サインイン",
      loggedIn: "ReClaude にサインイン済み",
      loggedInAs: "{{email}} としてサインイン中",
      logout: "サインアウト",
      loginTitle: "ReClaude にサインイン",
      emailLabel: "メール",
      ...
      mfaTitle: "2段階認証",
      mfaHint: "ReClaude アカウントの認証コードを入力してください",
      mfaCodeLabel: "認証コード",
    ...
    hostUnavailable: "このホストに接続するとプロバイダーの使用状況を確認できます",
    hostUpgradeRequired: "ホストを更新するとプロバイダーの使用状況を確認できます",
    clientUnavailable: "ホスト接続がまだ準備できていません",
    retry: "再試行",
    ...
    reset: {
      ...
      unitMinutes: "{{value}}分",
      unitSeconds: "{{value}}秒",
      resetsIn: "{{countdown}}後にリセット",
    },
    risk: {
      runsOutNow: "まもなく枯渇",
      runsOutDays: "{{value}}日後に枯渇",
      runsOutHours: "{{value}}時間後に枯渇",
      runsOutMinutes: "{{value}}分後に枯渇",
    },
    balance: {
      remaining: "残り {{amount}}",
    },
    ...
    windows: {
      ...
      weeklySonnet: "週間 · Sonnet",
      weeklyDesign: "週間 · Design",
      weeklyModel: "週間 · {{model}}",
      codeReview: "コードレビュー",
      monthly: "月間",
      codingUsage: "コーディング使用量",
      planUsage: "プラン使用量",
      modelInterval: "{{model}} · 間隔",
      modelWeekly: "{{model}} · 週間",
    },
    balances: {
      monthlyCredits: "月間クレジット",
      onDemandCap: "オンデマンド上限",
      prepaidCredits: "前払いクレジット",
      planUsage: "プラン使用量",
      credits: "クレジット",
    },
    plans: {
    ...
    detailValues: {
      ...
      monthly: "月間",
      unified: "統合",
      previousCycleCredits: "{{period}} · {{credits}} クレジット",
    },
    errors: {
      grokSignIn:
        "Grok Build の使用量を表示するには `grok login` でサインインするか、XAI_API_KEY を設定してください。",
      grokSessionExpired:
  ...
  settings: {
    ...
    modelGateways: {
      ...
      sheetTitle: "モデルゲートウェイ",
      add: "ゲートウェイを追加",
      addAccessibilityLabel: "モデルゲートウェイを追加",
      emptyTitle: "ゲートウェイなし",
      emptyHint:
        "OpenAI 互換エンドポイントを追加して、モデルのリクエストをゲートウェイ経由でルーティングします。",
      nativeSubtitle: "ネイティブプロバイダールーティング",
      cancel: "キャンセル",
      save: "保存",
      refresh: "更新",
      fields: {
        provider: "プロバイダー",
        providerHint:
          "モデルゲートウェイは、選択したプロバイダーのネイティブ設定形式を使用します。",
        name: "名前",
        namePlaceholder: "Local 9Router",
        baseUrl: "Base URL",
        protocol: "プロトコル",
        protocolHint:
          "Codex は現在、モデルゲートウェイで OpenAI Responses プロトコルのみをサポートしています。",
        protocolSelectAccessibilityLabel: "ゲートウェイプロトコルを選択",
        protocolSearchPlaceholder: "プロトコルを検索",
        protocolEmpty: "サポートされているプロトコルが見つかりません。",
        apiKey: "API キー",
        apiKeyPlaceholder: "任意",
        model: "モデル / 組み合わせ",
        modelSelectAccessibilityLabel: "ゲートウェイモデルを選択",
        modelPlaceholder: "モデル ID を選択または入力",
        modelSearchPlaceholder: "モデルを検索または ID を入力",
        modelCustomValuePrefix: "モデル ID を使用",
        modelEmpty: "モデルが見つかりません。モデル ID を入力してください。",
        modelHint:
          "デフォルトのゲートウェイルート、エイリアス、または組み合わせ。利用可能なモデルはゲートウェイから読み込まれます。",
      },
      discovery: {
        loading: "モデルを読み込み中...",
        available_one: "利用可能なモデル {{count}} 件",
        available_other: "利用可能なモデル {{count}} 件",
        idle: "利用可能なルートを読み込むか、ID を手動で入力してください。",
      },
      alerts: {
        nameRequiredTitle: "名前が必要です",
        nameRequiredMessage: "このゲートウェイの名前を入力してください。",
        baseUrlRequiredTitle: "Base URL が必要です",
        baseUrlRequiredMessage: "ゲートウェイの Base URL を入力してください。",
        unsupportedProtocolTitle: "サポートされていないプロトコル",
        unsupportedProtocolMessage:
          "Codex は現在、モデルゲートウェイで OpenAI Responses プロトコルのみをサポートしています。",
        saveFailedTitle: "ゲートウェイを保存できません",
        removeFailedTitle: "ゲートウェイを削除できません",
      },
      row: {
    ...
    appearance: {
      ...
      terminal: {
        ...
        colorScheme: {
          title: "配色",
          hint: "アプリのテーマとは独立してターミナルの配色を上書きし、シェルのプロンプトを読みやすく保ちます",
          accessibilityLabel: "ターミナルの配色：{{value}}",
          options: {
            auto: "テーマに従う",
            highContrastDark: "ハイコントラスト（ダーク）",
            highContrastLight: "ハイコントラスト（ライト）",
          },
        },
        ligatures: "フォント合字",
        ligaturesHint:
        ...
        paddingTop: "上の余白",
        paddingTopAccessibility: "ターミナルの上の余白",
        paddingBottom: "下の余白",
        paddingBottomAccessibility: "ターミナルの下の余白",
        paddingLeft: "左の余白",
        paddingLeftAccessibility: "ターミナルの左の余白",
        paddingRight: "右パディング",
        paddingRightAccessibility: "ターミナルの右パディング",
      },
      windowsTerminal: {
        title: "Windows ターミナル",
        hint: "接続先ホストが Windows の場合のみ有効。macOS と Linux では無視されます",
        preferPowerShell7: "PowerShell 7 を優先",
        preferPowerShell7Hint:
          "新しいターミナルを pwsh で起動し、無ければ Windows PowerShell、次に cmd.exe にフォールバック",
        preferPowerShell7Accessibility: "Windows で PowerShell 7 を優先",
        launchAsAdmin: "管理者として起動",
        launchAsAdminHint:
          "gsudo で権限を昇格してターミナルを起動（有効化には gsudo のインストールが必要。無い場合は通常権限で実行）",
        launchAsAdminAccessibility: "Windows ターミナルを管理者として起動",
      },
    },
    shortcuts: {
      dialogTitle: "ショートカット",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchive: {
          ...
          hint: "プルリクエストがマージされた後、変更のないクリーンな Paseo ワークスペースを自動でアーカイブします",
          updateFailedTitle: "ワークスペースを更新できません",
        },
      },
      schedules: {
    ...
    providers: {
      ...
      command: {
        ...
        title: "{{provider}} コマンド",
        label: "起動コマンド",
        placeholder: "例: reclaude",
        hint: "このプロバイダーの起動に使うバイナリを置き換えます。スペース区切り。適用にはデーモンが再起動します。",
        save: "保存して再起動",
        saving: "保存中…",
        failedToSave: "コマンドの保存に失敗しました",
      },
      reclaude: {
        title: "reclaude コマンドを使用",
        hint: "reclaude ラッパー経由で Claude Code を起動します。適用にはデーモンが再起動します",
        acpHint: "Claude Agent SDK トランスポートでのみ利用可能",
        toggleAccessibility: "reclaude コマンドを使用",
        errorTitle: "プロバイダーコマンドを更新できません",
      },
      claudeTransport: {
        title: "トランスポート",
        hint: "Claude を Agent SDK（デフォルト）または ACP プロトコルで実行します。適用にはデーモンが再起動します。",
        sdk: "SDK",
        acp: "ACP",
        confirm: "切り替え",
        switchToAcpConfirmTitle: "ACP トランスポートに切り替えますか？",
        switchToAcpConfirmBody:
          "ACP は claude-agent-acp シムを介して Claude を実行します。Rewind、Fast、Ultracode は利用できず、SDK トランスポートで作成したセッションは ACP モードでは再開できません。",
        switchToSdkConfirmTitle: "SDK トランスポートに切り替えますか？",
        switchToSdkConfirmBody:
          "ACP トランスポートで作成したセッションは Agent SDK では再開できません。適用にはデーモンが再起動します。",
        errorTitle: "トランスポートの切り替えに失敗しました",
      },
    },
    project: {
      noEditableTarget:
  ...
  ssh: {
    ...
    hosts: {
      title: "ホスト",
      empty: "ホストがありません",
      emptyDescription: "SSH で接続するホストを追加します。",
      newHost: "新しいホスト",
      connect: "接続",
      edit: "編集",
      connecting: "接続中…",
      connectFailed: "接続に失敗しました",
      hostKeyMismatchTitle: "ホストキーが変更されました",
      hostKeyMismatchBody:
        "{{host}} のホストキーが記録と一致しません。中間者攻撃の可能性があります。この変更を信頼する場合のみ更新してください。",
      hostKeyMismatchConfirm: "新しいキーを信頼",
      unavailable: "SSH マネージャーを使うにはホストを更新してください。",
      menu: {
        newTabConnect: "新しいタブで接続",
        closeAllShells: "すべての SSH シェルを閉じる",
        closeAllShellsTitle: "すべての SSH シェルを閉じますか？",
        closeAllShellsMessage: "すべてのホストにわたって {{count}} 個の SSH ターミナルを閉じます。",
      },
    },
    connect: {
      tabLabel: "接続中",
      ...
      close: "閉じる",
      ended: "この接続は終了しました。",
      mismatchTitle: "ホストキーが変更されました",
      mismatchMessage:
        "ホストキーが記録と一致しません。この変更を予期していた場合のみ信頼してください。",
      errorTitle: "接続に失敗しました",
      genericError: "接続に失敗しました",
      retryingLog: "再試行中…",
      trustingLog: "ホストキーを信頼して再接続しています…",
      savePasswordTitle: "パスワードを保存しますか？",
      savePasswordMessage: "このパスワードを {{host}} に保存して今後の接続に使用しますか？",
    ...
    form: {
      ...
      key: "SSH キー",
      keyNone: "なし",
      useAgent: "SSH エージェントを使用",
      useFido2: "FIDO2 セキュリティキー",
      agentForwarding: "エージェント転送",
      useAgentHint:
      ...
      startupSnippet: "起動スニペット",
      hostChaining: "ホストチェーン",
      proxy: "プロキシ",
      environment: "環境変数",
      charset: "文字セット",
      backspace: "バックスペースキー",
      ...
      cancel: "キャンセル",
      delete: "削除",
      fido2Notice: "FIDO2 キーはシステムの ssh バイナリ経由で接続します。",
      moshNotice: "Mosh はシステムの mosh バイナリ経由で接続します。",
    },
    keychain: {
      title: "キーチェーン",
      empty: "キーがありません",
    ...
    knownHosts: {
      ...
      empty: "既知のホストがありません",
      import: "インポート",
      imported: "{{count}} 件のホストキーをインポートしました",
      delete: "削除",
    },
    logs: {
      title: "ログ",
    ...
    uploads: {
      dropSheet: {
        title: "{{host}} にドロップ",
        pastePaths: "パスを貼り付け",
        pastePathsDescription: "ローカルファイルのパスをターミナル入力に挿入します",
        scanning: "ドロップされた項目をスキャン中…",
        scanningDescription: "ドロップされたフォルダー内のファイルを数えています",
        uploadAll: "すべて（{{count}} 件）のファイルをアップロード",
        nothingToUpload: "ドロップされた項目にアップロード可能なファイルがありません",
        uploadDescription: "SFTP でリモートホストに {{size}} を送信します",
        uploadDescriptionTruncated: "SFTP で {{size}} を送信します（ファイル一覧は省略）",
        destDirLabel: "リモートの保存先ディレクトリ",
        sftpUnavailable:
          "このホストは Mosh/FIDO2 で接続しているため、SFTP アップロードは利用できません",
        uploadFailed: "アップロードに失敗しました：{{error}}",
      },
      panel: {
        title: "SSH アップロード",
        empty: "アップロードはまだありません",
        stopAll: "すべてのアップロードを停止",
        clearFinished: "完了したアップロードをクリア",
        close: "パネルを閉じる",
        statusActive: "アップロード中 {{percent}}%",
        status: {
          active: "アップロード中",
          done: "完了",
          error: "失敗",
        ...
        pillActive: "{{count}} 件アップロード中",
        pillIdle: "{{count}} 件のアップロード",
      },
      menu: {
        jumpDir: "このフォルダーをターミナルで開く",
        jumpFile: "ファイルのあるフォルダーをターミナルで開く",
        copyRemotePath: "リモートパスをコピー",
        cancelFile: "このファイルのアップロードを停止",
        cancelDir: "このフォルダー内のアップロードを停止（{{count}}）",
        cancelUpload: "このアップロードを停止",
      },
      jump: {
        noTerminal: "このホストに接続中のターミナルがありません",
        busyTitle: "ターミナルは実行中",
        busyMessage: "ターミナルはタスクを実行中のようです。cd コマンドを送信しますか？",
        busyConfirm: "それでも移動",
      },
    },
  },
