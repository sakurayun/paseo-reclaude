...
export const fr: TranslationResources = {
  ...
  message: {
    actions: {
      ...
      showFullResponse: "Afficher {{count}} sections masquées",
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      confirm: {
        ...
        deleteMessage: "Supprimer « {{name}} » ? Cette action ne peut pas être annulée.",
      },
      toasts: {
        created: "Créé",
        renamed: "Renommé",
        duplicated: "Dupliqué",
        deleted: "Supprimé",
        localOnly: "Disponible uniquement avec un host local sur le bureau",
        updateHostToMutate: "Mettez à jour le host pour gérer les fichiers.",
        copyContentsBinary: "Impossible de copier le contenu d'un fichier binaire",
      },
      actions: {
        back: "Dos",
        retry: "Réessayer",
  ...
  providerUsage: {
    ...
    balances: {
      ...
      prepaidCredits: "Crédits prépayés",
      planUsage: "Utilisation du forfait",
      credits: "Crédits",
    },
    plans: {
    ...
    details: {
      ...
      weekResets: "Réinitialisation hebdo",
  ...
  settings: {
    ...
    project: {
      ...
      appearance: {
        ...
        urlRequired: "Saisissez l'URL d'un favicon",
        customRequired: "Saisissez 1 à 8 caractères",
        saved: "Apparence du projet enregistrée",
        saveFailed: "Impossible d'enregistrer l'apparence du projet",
