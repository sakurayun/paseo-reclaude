...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.2.3", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.150.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.0.22", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.18.1", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
