...
- Backend guidelines: `.trellis/spec/expo-two-way-audio/backend/`

- Frontend guidelines: `.trellis/spec/expo-two-way-audio/frontend/`

### Package: @getpaseo/highlight (`spec/highlight/`)

- Backend guidelines: `.trellis/spec/highlight/backend/`

- Frontend guidelines: `.trellis/spec/highlight/frontend/`
...
- Backend guidelines: `.trellis/spec/client/backend/`
...
- Frontend guidelines: `.trellis/spec/website/frontend/`
