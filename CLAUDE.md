...
| [docs/new-theme.md](docs/new-theme.md)                             | Fork "new theme" toggle — standalone light look (sidebar #fafafa), dedicated `newTheme` Unistyles key, where overrides go         |
...
| [docs/pairing.md](docs/pairing.md)                                 | Desktop ↔ desktop pairing via relay — copy pair link on B, paste link on A                                                        |
| [docs/service-proxy.md](docs/service-proxy.md)                     | Service proxy: exposing workspace scripts at public URLs, DNS setup, reverse proxy config                                         |
| [docs/port-forwarding.md](docs/port-forwarding.md)                 | TCP tunnel: forwarding a remote dev-server port to client localhost over the daemon connection (ssh -L), OAuth/localhost fidelity |
